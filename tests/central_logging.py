...
http_handler_config = {
    ...
    'host': None,  # legitimate host value is supplied later...
    }
...
def get_central_logger(
    ...
    http_handler_config.update(http_handler_config_update)
